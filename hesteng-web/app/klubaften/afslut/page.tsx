...
export default function AfslutKlubaftenPage() {
  ...
  async function deleteCurrentClubNightPermanently() { if (!clubNightId) return; await closeGuestAccess("aborted"); deleteCompletedMatchesForClubNightInClub(currentClubId, clubNightId, currentMatchIds); removeEloEventsForClubNightInClubAndRebuildRatings(currentClubId, clubNightId, currentMatchIds); deleteClubNight(clubNightId); router.push("/klubaften"); }
