      ...
      <section className="mx-auto max-w-4xl p-6 sm:p-10">
        ...
        <div className="rounded-3xl border border-gray-800 bg-gray-900 p-6 sm:p-8">
          ...
          <p className="mt-3 max-w-2xl text-gray-400">
            Opret ét offentligt link til den aktive klubaften. Spillere kan åbne puljer og kampe uden HESTENG-login.
          </p>
          ...
          <div className="mt-8 rounded-2xl border border-gray-800 bg-gray-950 p-5 text-sm text-gray-400">
            Gæstesiden følger klubaftenen automatisk, når gæsteadgang er aktiveret. Når klubaftenen afsluttes, bliver offentlig scoring lukket.
          </div>

          <div className="mt-6 flex flex-wrap gap-3">
            <Link href={`/klubaften/${clubNight.id}`} className="rounded-xl border border-gray-700 px-4 py-3 font-bold text-gray-300 hover:border-orange-500 hover:text-orange-300">
              Tilbage til live-overblik
            </Link>
            <Link href={`/klubaften/${clubNight.id}/kampe`} className="rounded-xl bg-orange-500 px-4 py-3 font-black text-black hover:bg-orange-400">
              Se kampe
            </Link>
          </div>
        </div>
